...
int 
clusterExtraction(pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud,pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloudFiltered, pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud_cluster)
{
